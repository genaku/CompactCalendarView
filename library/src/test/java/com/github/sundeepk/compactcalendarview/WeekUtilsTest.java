...
public class WeekUtilsTest {
    ...
    public void itShouldReturnCorrectWeekDaysWhenSundayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.SUNDAY, false);
    ...
    public void itShouldReturnCorrectWeekDaysWhenMondayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.MONDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenTuesdayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.TUESDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenWednesdayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.WEDNESDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenThursdayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.THURSDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenFridayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.FRIDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenSaturdayIsFirstDay(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.SATURDAY, false);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenSundayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.SUNDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenMondayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.MONDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenTuesdayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.TUESDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenWednesdayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.WEDNESDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenThursdayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.THURSDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenFridayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.FRIDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
    ...
    public void itShouldReturnCorrectWeekDaysWhenSaturdayIsFirstDayWith3Letters(){
        ...
        String[] actualWeekDays = WeekUtils.INSTANCE.getWeekdayNames(Locale.ENGLISH, Calendar.SATURDAY, true);
        assertArrayEquals(expectedWeekDays, actualWeekDays);
    }
