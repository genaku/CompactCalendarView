...
import com.github.sundeepk.compactcalendarview.CompactCalendarHelper.getMultipleEventsForEachDayAsMap
import com.github.sundeepk.compactcalendarview.CompactCalendarHelper.setTimeToMidnightAndGet
...
class EventsContainerTest {
    ...
    fun testItRemovesEventFromCacheIfEmpty() {
        ...
        assertEquals(underTest!!.getEventsForMonthAndYear(1, 2015), ArrayList<Events>())
    ...
    fun testItGetsEventsForSpecificDay() {
        ...
        //Sun, 07 Jun 2015 18:20:51 GMT
        val calendarDayEvents = underTest!!.getEventsFor(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))
    ...
    fun testItGetsEventsForMonth() {
        ...
        //Sun, 07 Jun 2015 18:20:51 GMT
        val calendarDayEvents = underTest!!.getEventsForMonth(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))
        assertNotNull(calendarDayEvents)
        //Assert 6th item since it will represent Sun, 07 Jun 2015 which is the day that we queried for
    ...
    fun testItReturnsEmptyForMonthWithNotEvents() {
        ...
        val calendarDayEvents = underTest!!.getEventsForMonth(setTimeToMidnightAndGet(Calendar.getInstance(), 1438949399000L))
    ...
    fun testItRemovesEventByDate() {
        ...
        assertEquals(1, underTest!!.getEventsFor(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))!!.size.toLong())
        assertEquals(events[6], underTest!!.getEventsFor(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))!![0])
        ...
        events.removeAt(6)
        assertEquals(0, underTest!!.getEventsFor(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))!!.size.toLong())
    }
    ...
    fun testItUpdatesEvents() {
        ...
        val calendarDayEvents2 = underTest!!.getEventsFor(setTimeToMidnightAndGet(Calendar.getInstance(), 1433701251000L))
