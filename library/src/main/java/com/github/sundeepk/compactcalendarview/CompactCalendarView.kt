...
class CompactCalendarView(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {

    private val animationHandler: AnimationHandler
    private val compactCalendarController: CompactCalendarController = CompactCalendarController(Paint(), OverScroller(context),
