...
internal class AnimationHandler(
        val compactCalendarController: CompactCalendarController,
    ...
    private var compactCalendarAnimationListener: CompactCalendarView.CompactCalendarAnimationListener? = null
